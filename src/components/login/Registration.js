...
const Registration = ({ registration, newUser }) => {
  ...
  return (
    ...
    <Row className='d-flex flex-column justify-content-center align-items-center'>
        <Col md={6} className='d-flex flex-column justify-content-center align-items-center' style={{marginTop: '100px', marginLeft: '10px', marginRight: '20px'}}>

        <Col style={{width: '100%', textAlign: 'center', textTransform: 'uppercase', fontSize: '18px', fontWeight: 'bold'}}>Форма регистрации на портале</Col>
        ...
        <Col className='mt-3' style={{fontSize: '12px'}}>Телегра ID обязателен для получяения сообщения об изменения статуса вашей заявки</Col>
